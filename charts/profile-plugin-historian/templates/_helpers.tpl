{{/*
Common helpers for profile-plugin-historian
*/}}
{{- define "mongodb.username" -}}
teknoir
{{- end -}}
{{- define "mongodb.password" -}}
{{- $name := "historian-mongodb-credentials" -}}
...
{{- end -}}
{{- define "mongodb.service_uri" -}}
{{- $user := include "mongodb.username" . -}}
{{- $pass := include "mongodb.password" . -}}
{{- printf "mongodb://%s:%s@historian-mongodb:27017/?authSource=admin" $user $pass -}}
{{- end -}}
{{- define "mongodb.service_uri_b64" -}}
{{- include "mongodb.service_uri" . | b64enc -}}
{{- end -}}
